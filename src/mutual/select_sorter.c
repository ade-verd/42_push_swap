...
/*   Updated: 2018/04/19 13:20:20 by ade-verd         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "push_swap.h"

void static	ft_first_three_values(t_heaps **ab, t_stack **work, int n)
{
	int		min;
	int		max;
	int		top;
...
void static	ft_n_more_values(t_heaps **ab, t_stack **work, int n)
{
	int		min;
	int		max;
	int		top;
